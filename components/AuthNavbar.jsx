...
export default function AuthNavbar({ user, isAdmin = false }) {
  ...
  const signupUrl = isAdmin ? '/auth/admin-signup' : '/auth/signup';
  const otherAuthUrl = isAdmin ? '/auth/login' : '/auth/admin-login';
