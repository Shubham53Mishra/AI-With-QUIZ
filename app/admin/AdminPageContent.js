  ...
  export default function AdminPageContent() {
    ...
    const fetchUploadHistory = async () => {
      try {
        ...
        if (!response.ok) {
          console.warn('Failed to fetch upload history:', result.error, result.details);
          setUploadHistory([]);
        } else {
    ...
    // Prevent rendering if not authenticated (router will redirect)
    if (!isAuthenticated) {
      return null;
    }
    ...
    return (
      <main>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
          ...
          <div className={`pt-20 pb-10 pr-8 relative z-10 transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-20'}`}>
            <div className="container mx-auto px-4 max-w-7xl">
              {/* Page Header */}
              <div className="mb-12">
                <div className="flex items-center justify-between mb-3">
                  <div className="min-w-0">
                    <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-600 bg-clip-text text-transparent break-words">Admin Dashboard</h1>
                        ...
                        <div>
                          {selectedUser && selectedUser.isBlocked ? (
                            <div className="space-y-4">
                              ...
                              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-400 rounded-lg p-6 max-w-md mx-auto">
                                <div className="grid grid-cols-2 gap-6">
                                  <div>
            ...
            {activeTab === 'questions' && (
              <div className="space-y-8">
                      ...
                      {quizSets.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                          <svg className="w-16 h-16 text-gray-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2H3a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          </svg>
                ...
                {selectedQuizSet && (
                  <div className="fixed inset-0 bg-black bg-opacity-40 z-[100] overflow-y-auto">
                    <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 mt-16 transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-20'}`}> 
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              <button
                                ...
                                className="hover:bg-blue-700 rounded-lg p-2 pl-3 transition transform hover:scale-110"
                                style={{ minWidth: '44px' }}
                              >
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              ...
                              <div className="flex flex-col">
                                <span className="flex items-center gap-2 text-2xl font-semibold text-blue-50 bg-blue-700/80 px-4 py-2 rounded-lg shadow">
                                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                                  </svg>
                                  {selectedQuizSet.name}
                                  <span className="ml-3 bg-white/20 text-blue-100 text-xs font-bold px-3 py-1 rounded-full">
